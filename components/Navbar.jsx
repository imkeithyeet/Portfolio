...
const Navbar = () => {
    ...
    useEffect(() =>{
        if (
            router.asPath === '/UsDating' ||
            router.asPath === '/BirdViewHouseListing' 
        ){
    ...
    return (
        ...
        className={
            ...
            >
                <div className={
                    nav 
                    ? 'fixed left-0 top-0 w-[75%] sm:w-[60%] md:w-[45%] h-screen bg-[#e1e1e1] p-10 ease-in duration-500'
                    ...
                    <div>
                        <div className="flex w-full items-center justify-between">
                            <Link href="/">
                            <Image src='/assets/navLogo.png' width="250" height="100" alt='/'/>
                            </Link>
                        ...
                        <div className="border-b border-gray-300 my-4">
                            <p className="w-[85%] md:w-[90%] py-4">Feel amazing while using it</p>
                        </div>
                    </div>
